...
public class SceneGraph extends JPanel {
	...
	private TransformedObject rotatingPoly;
	...
	private void createWorld() {
		...
		rotatingPoly  = new TransformedObject(filledPolygon);
		rotatingPoly.setTranslation(-0.52,0.04).setScale(0.016, 0.016).setColor(Color.black);
        rotatingPoly1 = new TransformedObject(filledPolygon);
        rotatingPoly1.setTranslation(1.55,-0.75).setScale(0.016, 0.016).setColor(Color.black);
        rotatingPoly2 = new TransformedObject(filledPolygon);
        rotatingPoly2.setTranslation(-3.22,1.67).setScale(0.012,0.012).setColor(Color.black);
        rotatingPoly3 = new TransformedObject(filledPolygon);
        rotatingPoly3.setTranslation(-1.67,1.12).setScale(0.012,0.012).setColor(Color.black);
        rotatingPoly4 = new TransformedObject(filledPolygon);
        rotatingPoly4.setTranslation(1.23,2.12).setScale(0.01,0.01).setColor(Color.black);
        rotatingPoly5 = new TransformedObject(filledPolygon);
        rotatingPoly5.setTranslation(2.48,1.66).setScale(0.01,0.01).setColor(Color.black);
        
        Rect  = new TransformedObject(filledRect);	
        ...
        Tri  = new TransformedObject(filledTriangle);
